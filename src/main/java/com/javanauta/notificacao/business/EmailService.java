...
import com.javanauta.notificacao.infrastructure.exception.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try {
            ...
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mensagem, true, UTF_8.name());
